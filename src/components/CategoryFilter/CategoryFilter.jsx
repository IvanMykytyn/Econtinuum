            ...
            {!categoryList && (
                <ul className="category-list">
                    <li
                        id="category-any"
                        className={
                            categorySelectedOption === initialCategories.any ? "active-category" : ""
                        }
                        onClick={() => {
                    ...
                    <li
                        id="category-waste"
                        className={
                            categorySelectedOption === initialCategories.waste ? "active-category" : ""
                        }
                        onClick={() => {
                    ...
                    <li
                        id="category-sorting"
                        className={
                            categorySelectedOption === initialCategories.sorting ? "active-category" : ""
                        }
                        onClick={() => {
                    ...
                    <li
                        id="category-tech"
                        className={
                            categorySelectedOption === initialCategories.tech ? "active-category" : ""
                        }
                        onClick={() => {
                    ...
                    <li
                        id="category-flora"
                        className={
                            categorySelectedOption === initialCategories.flora ? "active-category" : ""
                        }
                        onClick={() => {
                    ...
                    <li
                        id="category-land"
                        className={
                            categorySelectedOption === initialCategories.land ? "active-category" : ""
                        }
                        onClick={() => {
