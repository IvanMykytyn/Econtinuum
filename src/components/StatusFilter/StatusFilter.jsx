      ...
      {!statusList && (
        <ul className="status-list">
          <li
            id="status-any"
            className={
              statusSelectedOption === initialStatus.any
                ? "active-category"
                : ""
            }
            onClick={() => {
          ...
          >
            <BsCircle size={18} color={"#339BD6"} style={{ margin: "0 3px" }} />
            <p>Any</p>
          </li>
          <li
            id="status-success"
            className={
              statusSelectedOption === initialStatus.success
                ? "active-category"
                : ""
            }
            onClick={() => {
          ...
          <li
            id="status-failed"
            className={
              statusSelectedOption === initialStatus.failed
                ? "active-category"
                : ""
            }
            onClick={() => {
          ...
          <li
            ...
            className={
              statusSelectedOption === initialStatus.validating
                ? "active-category"
                : ""
            }
            onClick={() => {
