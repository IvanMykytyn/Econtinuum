...
const TaskHistory = ({loadTasks,isLoading,categoryFilter,statusFilter}) => {
    useEffect(()=>{
...
const mapDispatchToProps = dispatch => ({
    loadTasks : (categoryFilter,statusFilter) => dispatch(requestLoadTasks(categoryFilter,statusFilter))
})
