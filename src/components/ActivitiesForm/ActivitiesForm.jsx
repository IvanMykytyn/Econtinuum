...
import {
  ...
  NumbersIcon,
  PlanetIcon,
} from "../../pages/Activities/styles/images";
import FormInput from "../FormInput/FormInput";
import { connect } from "react-redux";
import {
  closeActivityForm,
  requestActivityForm,
} from "../../redux/activityForm/activityForm.actions";
  ...
  return (
    <div className="form-bg">
      <div className="form-box">
        <IoClose size={45} className="close-icon" onClick={closeForm} />
        <div className="form-description-box">
          ...
          <p className="p-count-of-points">
            {number_of_points} points per {unit_of_measure}
          </p>
